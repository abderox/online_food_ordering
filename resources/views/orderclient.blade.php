...
<div  class="container col-md-12 text-center">
  <h2 style="color:white;">Mon client</h2>
</div>

<div class="container">
  <div class="col-md-12 text-center">
  
      <a id="btn"  href="" class="btn btn-primary rounded-0 py-2 px-4">se localiser</a>
      <span class="submitting"></span>
                ...
                <div class="geodir-bubble-meta-side">
                    ...
                    <div class="geodir-output-location geodir-output-location-mapbubble">
                        <div class="geodir_post_meta  geodir-field-post_title"><span class="geodir_post_meta_icon geodir-i-text">
                            ...
                            <span class="geodir_post_meta_title">Place Title: </span></span>``</div>
                        <div class="geodir_post_meta  geodir-field-address" itemscope="" itemtype="http://schema.org/PostalAddress">
                            ...
                            <span class="geodir_post_meta_title">Address: </span></span><span itemprop="streetAddress">``</span>
                        </div>
                    </div>
                    </div>
                </div>
