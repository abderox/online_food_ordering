...
<div class="container">
  <header class="blog-header py-3">
    <div class="row flex-nowrap justify-content-between align-items-center">
      ...
      <div class="col-md-4 col-sm-5 col-xs-2 text-center">
        <a class="blog-header-logo text-dark " href="{{route('plats.index')}}">🛍️ CosaFood</a>
      </div>
  ...
  <div class="nav-scroller py-1 mb-2">
    <nav class="nav d-flex justify-content-between">
      ...
      <a class="p-2 text-muted" href="{{url('/maps1')}}">Orders</a>
      <a class="p-2 text-muted" href="{{url('/orderclient')}}">client map</a>
      <a class="p-2 text-muted" href="{{url('/myorders')}}">History</a>
...
@endif
  ...
  background-size:cover;  background-position:center;">
    <div class="col-md-12 px-0" style="text-align: center ;  text-shadow: 1px 2px 5px #000000">
      <h1 class="display-4 font-italic" >CozaFood <sup style="font-size:25px">&copy;</sup></h1>
      <p class="lead my-3  col-md-12 " style="color:black;">The only food company that serves both vegans and meat eaters , different religions ... </p>
            ...
            <div class="container text-center text-md-start mt-5">
              ...
              <div class="row mt-3">
                ...
                <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                  ...
                  <p>
                    Consultez le menu directement depuis votre mobile grâce à
                     notre application web ou sur Android et iOS. 
                    Ne ratez plus jamais l’occasion de vous faire plaisir !
                  </p>
                </div>
                <!-- Grid column -->
                ...
                <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                  ...
                  <p><i class="fas fa-home me-3"></i> Av.Abdelkarim Elkhattabi, Guéliz Marrakech</p>
                  <p>
